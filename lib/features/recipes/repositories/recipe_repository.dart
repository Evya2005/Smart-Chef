...
class RecipeRepository {
  ...
  /// Updates only the nutrition field. No version snapshot is created (enrichment use).
  Future<void> updateNutritionField(
      String uid, String recipeId, NutritionModel nutrition) async {
